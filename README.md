...
1. **プロンプトインジェクションの脅威**: 外部データを信頼することの危険性
2. **多層防御の重要性**: 単一の防御策に頼らない設計
3. **LLM vs LLM**: 同じモデルでも、設計次第で攻撃者にも防御者にもなる
4. **システムレベルのセキュリティ**: AIの判断に頼らず、システムで強制する
5. **Human-in-the-Loop**: 完全自動化とセキュリティのバランス
